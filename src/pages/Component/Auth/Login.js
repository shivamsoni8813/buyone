              ...
              <div
                ...
                <div className="g-0 lg:flex lg:flex-wrap">
                  <div className="px-4 md:px-0 lg:w-6/12">
                    <div className="md:mx-6 md:p-12 mt-[7rem] pt-2">
                      ...
                      <form>
                        ...
                        <div className="relative mb-4" data-te-input-wrapper-init>
                          <input
                            type="text"
                            className="peer block min-h-[auto] w-full rounded border-0 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:placeholder:text-orange [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                        ...
                        <div className="mb-12 pt-1 pb-1 text-center">
                          ...
                          <Link href={'/Component/Auth/Forgot'}>Forgot password?</Link>
                        </div>
                        <div className="flex items-center justify-between pb-6">
                          <p className="mb-0 mr-2">Don't have an account?</p>
                          <Link href={'/Component/Auth/SignUp'}>
                            <button
                              type="button"
